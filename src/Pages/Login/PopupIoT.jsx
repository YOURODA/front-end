...
export const PopupIoT = (props) => {
  const { createUserPopup, odaUser, setCreateUserPopup, odaName, setOdaName } =
    props;
  ...
  return (
    <ThemeProvider>
      ...
      {redirect && <Redirect to="/party-selection" />}
          ...
          >
            ...
            {ipList.map((value) => {
              ...
              return (
                ...
                >
                  <ListItemButton
                    onClick={() => sendOdaName(checked, defaultOdaName)}
                  >
                    <ListItemAvatar>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(PopupIoT)
);
