...
class SpotifyFooterMakeCor extends Component {
    ...
    componentDidMount() {
        ...
        if ('access_token' in params) {
            ...
            window.location.replace('https://accounts.spotify.com/authorize?client_id=' + '8c8d6401e5c24c5585d2e89e93804cd1' + '&redirect_uri=' + 'http://localhost:3000/create-party' + '&scope=' +
...
export default withRouter(
    connect(
        mapStateToProps,
        mapDispatchToProps
    )(withWidth()(SpotifyFooterMakeCor))
);
